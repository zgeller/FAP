...
/**
 * Chebyshev (LInfinity) distance measure. Time series must be the same length (n):
 *
 * <blockquote> <img src="doc-files/ChebyshevDistance-1.png"> </blockquote>
 * 
 * @author Zoltán Gellér
 * @version 2024.09.17.
 * @see AbstractCopyableDistance
 */
public class ChebyshevDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new Chebyshev (LInfinity) distance measure.
     */
    public ChebyshevDistance() {
    }

    /**
     * Constructs a new Chebyshev (LInfinity) distance measure and sets whether to
     * store distances.
     * 
     * @param storing {@code true} if storing distances should be enabled
     */
    public ChebyshevDistance(boolean storing) {
        super(storing);
    }
    ...
    public Object makeACopy(boolean deep) {
        ChebyshevDistance copy = new ChebyshevDistance();
        init(copy, deep);
        return copy;
    }
