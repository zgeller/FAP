...
/**
 * Clark distance measure. Time series must be the same length (n):
 * 
 * <blockquote> <img src="doc-files/ClarkDistance-1.png"> </blockquote>
 * 
 * <ul>
 ...
 */
public class ClarkDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new Clark distance measure.
     */
    ...
    public double distance(TimeSeries series1, TimeSeries series2) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (denominator != 0) {
                ...
                double tmp = numerator / MathUtils.getZeroDenominator();
                distance += tmp * tmp;
            }
    ...
    public Object makeACopy(boolean deep) {
        ClarkDistance copy = new ClarkDistance();
        init(copy, deep);
        return copy;
    }
