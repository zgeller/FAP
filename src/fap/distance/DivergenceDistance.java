...
/**
 * Divergence distance measure. Time series must be the same length (n):
 * 
 * <blockquote> <img src="doc-files/DivergenceDistance-1.png"> </blockquote>
 * 
 * <ul>
 ...
 */
public class DivergenceDistance extends AbstractCopyableDistance {
    ...
    public Object makeACopy(boolean deep) {
        DivergenceDistance copy = new DivergenceDistance();
        init(copy, deep);
        return copy;
    }
