...
/**
 * Hellinger distance measure. Time series must be the same length (n) and 
 * non-negative:
 *
 * <blockquote> <img src="doc-files/HellingerDistance-1.png"> </blockquote>
 * 
 * <p>
 * References:
 * <ol>
 ...
 */
public class HellingerDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new Hellinger distance measure.
     */
    ...
    public Object makeACopy(boolean deep) {
        HellingerDistance copy = new HellingerDistance();
        init(copy, deep);
        return copy;
    }
