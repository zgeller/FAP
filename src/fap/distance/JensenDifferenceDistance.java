...
/**
 * Jensen difference (information radius) distance measure. Time series must be
 * the same length (n) and non-negative:
 *
 * <blockquote> <img src="doc-files/JensenDifferenceDistance-1.png">
 * </blockquote>
 * 
 * <ul>
 ...
 * References:
 * <ol>
 *  <li> I.J. Taneja, On Generalized Information Measures and Their Applications,
 *       in: Adv. Electron. Electron Phys., 1989: pp. 327–413.
 *       <a href="https://doi.org/10.1016/S0065-2539(08)60580-6">
 *          https://doi.org/10.1016/S0065-2539(08)60580-6</a>.
 ...
 */
public class JensenDifferenceDistance extends AbstractCopyableDistance {
    ...
    public Object makeACopy(boolean deep) {
        JensenDifferenceDistance copy = new JensenDifferenceDistance();
        init(copy, deep);
        return copy;
    }
