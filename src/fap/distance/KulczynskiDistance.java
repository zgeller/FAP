 ...
 */
public class KulczynskiDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new Kulczynski distance measure.
     */
    public KulczynskiDistance() {
    }
    ...
    public Object makeACopy(boolean deep) {
        KulczynskiDistance copy = new KulczynskiDistance();
        init(copy, deep);
        return copy;
    }
