...
/**
 * Max symmetric chi-square distance measure. Time series must be the same length
 * (n) and they should be non-negative:
 * 
 * <blockquote> <img src="doc-files/MaxSymmetricChiSquareDistance-1.png"> </blockquote>
 * 
 * <ul>
 ...
 */
public class MaxSymmetricChiSquareDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new max symmetric chi-square distance measure.
     */
    public MaxSymmetricChiSquareDistance() {
    }

    /**
     * Constructs a new max symmetric chi-square distance measure, specifying
     ...
     *                memory for reuse
     */
    public MaxSymmetricChiSquareDistance(boolean storing) {
        super(storing);
    }
    ...
    public Object makeACopy(boolean deep) {
        MaxSymmetricChiSquareDistance copy = new MaxSymmetricChiSquareDistance();
        init(copy, deep);
        return copy;
    }
