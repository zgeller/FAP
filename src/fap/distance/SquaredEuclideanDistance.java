 ...
 */
public class SquaredEuclideanDistance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new squared Euclidean distance measure.
     */
    public SquaredEuclideanDistance() {
    }

    /**
     * Constructs a new squared Euclidean distance measure and sets whether to store
     * distances.
     * 
     * @param storing {@code true} if storing distances should be enabled
     */
    public SquaredEuclideanDistance(boolean storing) {
        super(storing);
    }
    ...
    public Object makeACopy(boolean deep) {
        SquaredEuclideanDistance copy = new SquaredEuclideanDistance();
        init(copy, deep);
        return copy;
    }
