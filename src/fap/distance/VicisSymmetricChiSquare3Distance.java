...
/**
 * Vicis symmetric chi-square 3 distance measure. Time series must be the same length
 * (n) and they should be non-negative:
 * 
 * <blockquote> <img src="doc-files/VicisSymmetricChiSquare3Distance-1.png"> </blockquote>
 * 
 * <ul>
 ...
 */
public class VicisSymmetricChiSquare3Distance extends AbstractCopyableDistance {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new vicis symmetric chi-square 3 distance measure.
     */
    public VicisSymmetricChiSquare3Distance() {
    }

    /**
     * Constructs a new vicis symmetric chi-square 3 distance measure, specifying
     ...
     *                memory for reuse
     */
    public VicisSymmetricChiSquare3Distance(boolean storing) {
        super(storing);
    }
    ...
    public Object makeACopy(boolean deep) {
        VicisSymmetricChiSquare3Distance copy = new VicisSymmetricChiSquare3Distance();
        init(copy, deep);
        return copy;
    }
